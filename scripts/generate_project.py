#!/usr/bin/env python3
"""Generate NurseryRhymes Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\NurseryRhymes")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "nurseryrhymes"
TEST = APP / "src" / "test" / "java" / "com" / "nurseryrhymes"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "nurseryrhymes"
...
rootProject.name = "NurseryRhymes"
include(":app")
'''
...
android {
    namespace = "com.nurseryrhymes"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.nurseryrhymes.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.nurseryrhymes.data.** { *; }
-keep class com.nurseryrhymes.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "nurseryrhymes-game",
    "storage_bucket": "nurseryrhymes-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.nurseryrhymes.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating NurseryRhymes project files...")
