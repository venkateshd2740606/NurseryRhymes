# NurseryRhymes — Google Play Data Safety Form Reference
...
- **Users can request deletion:** Contact privacy@nurseryrhymes.game; local data cleared via app settings or uninstall
