...
1. Open `D:\Work\Games\NurseryRhymes` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `NurseryRhymesEngine.kt` (tube pour logic) and update the game board UI component.
